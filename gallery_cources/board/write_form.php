                ...
                <div class="three-fourths column">
                    <div class="markdown-body">
                        ...
                        <?php
                            if($mode == "modify") {
                        ?>
                        <form name="form" id="form" action="../../lib/gallery/free_insert.php?mode=modify&num=<?= $num ?>&page=<?=$page?>&table=<?=$table?>" method="post" enctype="multipart/form-data">
                        <?php
                            }
                            else {
                        ?>
                            <form name="form" id="form" action="../../lib/gallery/free_insert.php?table=<?= $table ?>"
